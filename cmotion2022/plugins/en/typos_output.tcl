...
cMotion_abstract_register "typoFix" { "oops" "oops %SETTING{output:typos:typos:_:_}" "%colen" "ffs" "grrr %SETTING{output:typos:typos:_:_}" "%SETTING{output:typos:typos:_:_}" "-typo" "/butterfingers" }
